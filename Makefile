...
LINKED_TARGET = linked_add_back.c linked_add_front.c linked_new_node.c linked_new_list.c linked_del_node.c linked_kill_list.c linked_map.c

TESTS_TARGET = tests.c test_utils.c linked/test_add_back.c linked/test_add_front.c linked/test_kill_list.c linked/test_map.c
